...
def handle_start(message):
    ...
    markup.add("Лезгинский", "Аварский (в разработке)", "Кумыкский (в разработке)", "Даргинский (в разработке)", "Лакский (в разработке)")
    bot.send_message(message.chat.id, welcome_message, reply_markup=markup)

@bot.message_handler(func=lambda message: message.text in ["Лезгинский", "Аварский (в разработке)", "Кумыкский (в разработке)", "Даргинский (в разработке)", "Лакский (в разработке)"])
